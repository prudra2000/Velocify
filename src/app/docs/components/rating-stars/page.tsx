      ...
      <div className="flex flex-col w-full md:w-3/4 mt-5 gap-y-5">
        <div className="flex flex-col mt-5 gap-y-3">
          ...
          <p className="text-paragraph-secondary">
            The RatingStars component provides a dynamic and customizable way to
            display star-based ratings in your application. It allows users to
            interactively select or view ratings with options for different
            ...
            interaction, and applying custom styles. Ideal for feedback systems
            or product reviews, RatingStars ensures a visually appealing and
            user-friendly experience while maintaining full flexibility for
            integration into any design system.
          </p>
        </div>
        <div className="flex flex-col mt-5 gap-y-3">
