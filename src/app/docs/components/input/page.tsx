...
/>`;
  ...
  return (
    <>
      <head>
        <title>Velocify UI - Input</title>
        <meta
          name="description"
          content="Check out the Input component in Velocify UI"
        />
      </head>
        ...
        <div className="flex flex-col w-full md:w-3/4 mt-5 gap-y-5">
          <div className="flex flex-col mt-5 gap-y-3">
            ...
            <p className="text-paragraph-secondary">
              ...
              customizable input field, designed to seamlessly integrate with
              your application&apos;s UI. It supports various properties, such
              as variant, rounded, and status, allowing you to tailor its
              appearance and behavior to suit different use cases. Whether you
              need a simple text input, a file uploader, or an input with status
              indicators for validation, this component provides the flexibility
              to meet your design requirements while maintaining consistency
              across your project.
            </p>
          </div>
          <div className="flex flex-col mt-5 gap-y-3">
