...
const handleCloseDialog = () => {
  ...
  return (
    <>
      <head>
        <title>Velocify UI - Icon Button</title>
        <meta
          name="description"
          content="Check out the Icon Button component in Velocify UI"
        />
      </head>
        ...
        <div className="flex flex-col w-full md:w-3/4 mt-5 gap-y-5">
          <div className="flex flex-col mt-5 gap-y-3">
            ...
            <p className="text-paragraph-secondary">
              ...
              sizes, shapes, and visual variants to match your design needs.
              This component supports multiple icon styles and ensures
              accessibility with options for alt text. Whether you&apos;re
              looking for a subtle interaction with the ghost variant or a more
              prominent action button, the IconButton is designed to be both
              flexible and easy to implement in your UI. It also includes props
              for rounding, disabling, and customizing button styles, making it
