      ...
      <div className="flex flex-col w-full md:w-3/4 mt-5 gap-y-5">
        <div className="flex flex-col mt-5 gap-y-3">
          ...
          <p className="text-paragraph-secondary">
            ...
            border styles, allowing developers to tailor the avatar&apos;s appearance
            to match their application&apos;s design needs. The component also
            includes options for secondary styling and a disabled state, making
            it adaptable to various user interface scenarios. Additionally, the
            Avatar can be easily installed and integrated into your project,
            providing a seamless way to enhance user profiles in your web
            applications.
          </p>
        </div>
        <div className="flex flex-col mt-5 gap-y-3">
        ...
        <div className="flex flex-col mt-5 gap-y-2">
          <h1 className="text-2xl font-semibold text-white ">Avatar - Sizes</h1>
          <p className="text-paragraph-secondary"></p>
          <ElementShowcase
            codeShowcase={
              <CodeShowcase
