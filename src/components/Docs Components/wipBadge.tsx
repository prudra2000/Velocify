...
interface BadgeProps extends VariantProps<typeof badgeVariants> {
  ...
  variant?:
    ...
    | "error"
    | "custom";
  size?: "small" | "large" | "default" | "extraLarge"; // Removed "medium"
...
const WIPBadge: React.FC<BadgeProps> = ({
  children,
  content,
  variant,
  size,
